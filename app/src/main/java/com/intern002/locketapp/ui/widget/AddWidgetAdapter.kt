...
data class AddWidgetStep(
    val imageResId: Int,
    val description: String
)

class AddWidgetAdapter(
    private val steps: List<AddWidgetStep>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddWidgetViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_add_widget_step, parent, false)
    ...
    class AddWidgetViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val stepImage: ImageView = itemView.findViewById(R.id.iv_step_image)
        private val stepDescription: TextView = itemView.findViewById(R.id.tv_description)

        fun bind(step: AddWidgetStep) {
