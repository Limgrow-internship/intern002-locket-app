...
class ChatListAdapter(
    ...
    private fun formatDisplayTimestamp(isoString: String): String {
        return try {
            ...
            val date: Date = parser.parse(isoString) ?: return ""
        ...
        fun bind(conversation: Conversation) {
            ...
            when (val status = conversation.status) {
                ...
                is MessageStatus.Sent -> {
                    ...
                    binding.ivReadStatusIcon.setImageResource(R.drawable.ic_sent_check)
                }
